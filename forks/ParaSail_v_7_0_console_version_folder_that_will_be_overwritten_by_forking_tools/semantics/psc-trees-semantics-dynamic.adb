...
package body PSC.Trees.Semantics.Dynamic is
         ...
         begin
            ...
            for I in reverse 1 .. Num_Ancestors loop
               Result (I) := Known_Type_Desc
                              (Run_Time_Type_Info (Ancestor.Root_Type));
               Ancestor := Ancestor.Parent_Type;
            end loop;
   ...
   procedure Emit_Nested_Block_Start
     (New_Visitor : in out Code_Gen_Visitor;
      ...
      function Block_Region_Index_To_Use return Block_Region_Index is
         ...
         --  New_Visitor.Decl_Region, in which case return
         --  No_Block_Region_Index
         use Symbols;
      begin
         if Block_Region = New_Visitor.Decl_Region then
   ...
   begin
      if Target_Obj_Is_Null (New_Visitor) then
            ...
            Emit
              (New_Visitor,
               (Store_Large_Local_Null_Op,
                Source_Pos => Find_Source_Pos (Call_Sem.Definition),
                Destination => New_Visitor.Target_Object,
                Dest_Name => Strings.Null_U_String_Index,
      ...
      elsif New_Visitor.Target_Object.Base = Local_Area
      ...
      Emit_Nested_Block_Start
        (New_Visitor,
         ...
         Block_Region => New_Visitor.Decl_Region,
         New_Code => Block_Code'Unchecked_Access,
         Instr_Opcode => Start_Parallel_Op,
   ...
   begin  --  Emit_Block_For_Check
      ...
      Emit_Nested_Block_Start
        (Visitor,
         ...
         New_Code => Check_Code'Unchecked_Access,
                     ...
                     begin
                        ...
                        Emit_Nested_Block_Start
                          (Cg_Visitor,
                           ...
                           New_Code => Dq_Cond_Code'Unchecked_Access);
