...
package body PSC.Interpreter is
   ...
   begin
      if Routine_Addr /= null then
         ...
         Routine_Addr (Context, Params, To_Non_Op_Map_Type_Desc (Static_Link));
      else
      ...
      then
         ...
         begin
            ...
            then
               --  Fast path
               if Info.Use_Static_Link_For_Type then
                  Code.Routine_Addr (Context, Params, Static_Link);
               else
                  Code.Routine_Addr (Context, Params, Info.Type_Desc);
               end if;
               return;
            end if;
         end;
